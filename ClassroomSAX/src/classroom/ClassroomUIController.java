...
public class ClassroomUIController implements Initializable {
    ...
    private void handleOpen(ActionEvent event) {
        ...
        if (file != null) {
            try {
                CourseXMLLoader.parse(file, (String result) -> {
    ...
    private void displayAboutAlert() {
        ...
        alert.setHeaderText("Powerful SAX XML Paswer");
        alert.setContentText("-----------------------");

        TextArea textArea = new TextArea("This application can parse any right XML file using SAX!");
